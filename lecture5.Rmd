...
```{r saving1, echo=FALSE,fig.cap='How to save as csv (1)',out.width="50%", fig.align='center'}
...
click on File then Import then select Data from Text (base)  
...
```{r saving3, echo=FALSE,fig.cap='Import Dataset dialogue box',out.width="50%", fig.align='center'}
...
data<-read.csv(file = 'data/iris.csv')

# here now the data set iris.csv is stored in the name data

#You can now directly do operations on the data
